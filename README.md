...
- InstantPrompts.lua: Makes all Proximityprompts instant to interact with, including newly added prompts.
- InstantEquip.lua: Inherits from the abstract GunSettings class - which detects all guns and modifies their settings to achieve instant equip time.
