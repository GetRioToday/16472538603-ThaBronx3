...
These scripts are relatively fresher:
- [Movement Disabler](Movement%20Disabler.luau): Takes advantage of Roblox's beautiful replication to "disable" the server anticheat - this will let you speed however fast you want, jump however high you want, and teleport instantly anywhere.
- [Instant Prompts (OOP)](InstantPrompts.luau): Makes all Proximityprompts instant to interact with, including newly added prompts.
- [Instant Equip (OOP)](InstantEquip.lua): Inherits from the abstract GunSettings class - which detects all guns and modifies their settings to achieve instant equip time.
- [Studio Farm](StudioFarm.luau): Automatically robs the "On The Radar" studio, and will wait for cash to respawn before robbing again, and again, and again.
